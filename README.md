# Healthcare Recruitment Analytics
...
## Tools & Skills
* **SQL:** Database Schema Design, Relational Modeling, Data Extraction.
* **Power BI:** Data Modeling, DAX, KPI Reporting, Dashboard Design.
* **GitHub:** Portfolio Documentation & Version Control.

## Key Insights
* Hospital-based roles generally show a longer time-to-fill than academic faculty positions.
* Salary expectations demonstrate a clear positive correlation with years of professional experience.
